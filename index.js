...
function start() {
  ...
  setTimeout(()=>{metro.createTrain(BLUE, bannan[0]);}, 300);
  setTimeout(()=>{metro.createTrain(GREEN, songshanXindian[0]);}, 600);
  setTimeout(()=>{metro.createTrain(YELLOW, zhongheXinlu[0]);}, 900);
