...
class Util {
  ...
  pushVerts (program, floatArray, triangleCnt) {
    ...
    this.gl.bufferSubData(this.gl.ARRAY_BUFFER, this.currentBufferEnd, f32arr);
    let shapeLoc = this.currentBufferEnd;
    this.currentBufferEnd += f32arr.byteLength;
